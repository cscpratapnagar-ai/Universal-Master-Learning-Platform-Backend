...
-- Some development databases may already record the semantic-RAG migration
-- without having the table present. Recreate the table safely in that case.
