...
public class Assessment extends BaseEntity {
    ...
    public Assessment(Course course, String title, int passingScore) {
        this.course = course;
        this.title = title;
        this.passingScore = passingScore;
        this.assessmentLevel = "COURSE";
    }

    public Assessment(Course course, CourseModule module, Lesson lesson,
                      String assessmentLevel, String title, int passingScore) {
        this.course = course;
        this.module = module;
        this.lesson = lesson;
    ...
    public String getAssessmentLevel() { return assessmentLevel; }
