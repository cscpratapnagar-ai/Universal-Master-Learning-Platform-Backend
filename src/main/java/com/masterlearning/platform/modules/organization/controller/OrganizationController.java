...
public class OrganizationController {
 ...
 @PutMapping("/{id}/profile") @PreAuthorize("hasRole('SUPER_ADMIN')") public ApiResponse<OrganizationProfileResponse> updateProfile(@PathVariable UUID id,@Valid @RequestBody UpdateOrganizationProfileRequest r){return ApiResponse.success("Organization profile updated successfully",service.updateProfile(id,r));}
 @PutMapping("/{id}/status") @PreAuthorize("hasRole('SUPER_ADMIN')") public ApiResponse<OrganizationProfileResponse> updateStatus(@PathVariable UUID id,@Valid @RequestBody UpdateOrganizationStatusRequest r){return ApiResponse.success("Organization status updated successfully",service.updateStatus(id,r));}
