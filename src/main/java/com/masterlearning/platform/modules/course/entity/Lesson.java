...
public class Lesson extends BaseEntity {
    ...
    @Column(length=30) private String contentType="TEXT";
    @Column(length=4000) private String content;
    @Column(name="sort_order",nullable=false) private int sortOrder;
    @Column(name="completion_mode",nullable=false,length=30) private String completionMode="MANUAL_COMPLETE";

    protected Lesson(){}
    public Lesson(CourseModule module,String title,String contentType,String content,int sortOrder){
        this.module=module;this.title=title;this.contentType=contentType;this.content=content;this.sortOrder=sortOrder;
    }
    ...
    public void updateDetails(String title,String contentType,String content,int sortOrder){
        this.title=title;
